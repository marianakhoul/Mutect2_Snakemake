...
rule GetPileupSummariesTumor:
	...
	output:
		table = protected("results/GetPileupSummariesTumor/{base_file_name}/tumor_{base_file_name}_pileup.tab")
	params:
		gatk = config["gatk_path"],
		small_exac_common = config["small_exac_common"],
		reference_genome = config["reference_genome"]
	log:
		"logs/GetPileupSummariesTumor/{base_file_name}_GetPileupSummaries_tumor.txt"
	shell:
